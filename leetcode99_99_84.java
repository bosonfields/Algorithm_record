...
//    }
    ...
    public static void traversal(TreeNode[] tArr, TreeNode root){
        if(root == null){
            return;
        }
        traversal(tArr, root.left);
        tArr[0] = root;
        visit(tArr);
        traversal(tArr, root.right);
    }

    private static void visit(TreeNode[] tArr){
    ...
    private static void swap(TreeNode[] tArr){
